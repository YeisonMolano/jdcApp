...
class Estudiantes_pendientes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.findViewById<Button>(R.id.accept_student).visibility = View.GONE
        this.findViewById<Button>(R.id.rejected_student).visibility = View.GONE
    ...
    fun showUser(view: View) =
        if(!findViewById<Spinner>(R.id.spinner_studenst_pending).selectedItem.toString().equals("Ver estudiantes pendientes")){
            ...
            var student =  db.findUserInsrciption(findViewById<Spinner>(R.id.spinner_studenst_pending).selectedItem.toString().split(" ")[0].toInt())
            findViewById<Button>(R.id.students_active).visibility = View.GONE
            ...
            this.findViewById<Button>(R.id.accept_student).visibility = View.VISIBLE
            this.findViewById<Button>(R.id.rejected_student).visibility = View.VISIBLE
        }else{
    ...
    fun recharge(view: View){
        ...
        this.findViewById<TextView>(R.id.programStudentPending).visibility = View.GONE
        this.findViewById<ImageView>(R.id.imageView5).visibility = View.GONE
        findViewById<Button>(R.id.students_active).visibility = View.VISIBLE
    }

    fun acceptStudent(view:View){
        db.updateRolToStudent(findViewById<Spinner>(R.id.spinner_studenst_pending).selectedItem.toString().split(" ")[0].toInt())
        chargeList()
        findViewById<TextView>(R.id.email_estudiante_pendiente).visibility = View.GONE
        findViewById<TextView>(R.id.program_estudiante_pendiente).visibility = View.GONE
        findViewById<TextView>(R.id.birthdate_estudiante_pendiente).visibility = View.GONE
